    ...
    return(
        <div className="flex justify-end items-center border-b-4 p-6">
            ...
            <a href="https://www.linkedin.com/in/suresh-s0/" target="_blank" className="text-white p-1 mr-1">
                    <img align="center" src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/linked-in-alt.svg" alt="suresh-s003" height="10" width="20" /></a>

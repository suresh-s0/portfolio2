function Topbar() {
    ...
    return (
        <div className="flex justify-center bg-gray-800 bg-opacity-75 sticky top-1 font-mono  shadow-lg  shadow-gray-800 border xl:w-full lg:w-full sm:w-2/3 md:w-full  ">
            <div className=" flex justify-around  rounded px-4 py-2 border xl:w-1/3  sm:w-2/3 md:w-2/3   ">
